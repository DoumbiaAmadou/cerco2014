...
let translate_stmt
  ...
  match stmt with
    ...
    | RTLabs.St_addi (_,_,_,_) -> assert false

    | RTLabs.St_lw (_,_,_,_,_) -> assert false

    | RTLabs.St_sw (_,_,_,_,_) -> assert false

    | RTLabs.St_cmp_zero (_,_,_,_) -> assert false

    | RTLabs.St_cmp (_,_,_,_,_) -> assert false
